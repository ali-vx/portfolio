    ...
    <div name='contact' className='w-full h-screen bg-[#212529] flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/78c17d13-5c1c-456d-bd1c-65ed7a3014f3" className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                ...
                <p className='text-[#A6A7A9] py-4'>Submit the form below or shoot me an email - <a className='text-[#FD413C]' target="_blank" rel="noopener noreferrer" href='mailto:amuhammad161@gmail.com'>amuhammad161@gmail.com</a></p>
            </div>
            ...
            <button className='see-more-btn text-white border-2 hover:bg-[#FD413C] hover:border-[#FD413C] px-4 py-3 my-8 mx-auto flex items-center'>Let's Collaborate</button>
        </form>
    </div>
  )
}
