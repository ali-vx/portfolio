...
import MovieImg from '../assets/project-1.png';
import WordleImg from '../assets/project-2.png';

const Projects = () => {
  return (
    <div name='projects' className='w-full md:h-screen text-gray-300 bg-[#212529] pt-20'>
