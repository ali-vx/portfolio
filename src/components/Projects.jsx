        ...
        <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-4'>
          ...
          >
            ...
            <div className='opacity-0 group-hover:opacity-100'>
              ...
              <div className='pt-8 text-center'>
                <a target="_blank" rel="noopener noreferrer" href='https://ali-vx.github.io/react-codepen-clone/'>
                  <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>
                    Demo
                  </button>
                </a>
                <a target="_blank" rel="noopener noreferrer" href='https://github.com/ali-vx/react-codepen-clone'>
                  <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>
                    Code
                  </button>
                </a>
          ...
          <div
            className='bg-WeatherImg hover:bg-WeatherImgHover hover:scale-105 duration-500 shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div'
          >
            {/* Hover Effects */}
            <div className='opacity-0 group-hover:opacity-100 text-center'>
              <span className='text-2xl font-bold text-white tracking-wider'>
                React Movies and TV Show Watchlist
              </span>
              <div className='pt-8 text-center'>
                <a target="_blank" rel="noopener noreferrer" href='https://ali-vx.github.io/react-watchlist/'>
                  <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>
                    Demo
                  </button>
                </a>
                <a target="_blank" rel="noopener noreferrer" href='https://github.com/ali-vx/react-watchlist'>
                  <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>
                    Code
                  </button>
                </a>
